...
@stop
@section('content')
        <div id="outerwrapperContactText">
            <div id="contactText">
            <h1 class="ueberschriftenImpressum" id="impressumText">Impressum</h1>
            <h2 id="firstSentenceImpressum">Diese Website entstand im Rahmen eines Studienprojekts an der Beuth Hochschule für Technik Berlin.</h2>
            <br>

            <h3 class="ueberschriftenImpressum" >Angaben gemäß § 5 TMG:</h3>
            <p>Timo Bruns, Annika Schöttle, Paul Weimer, Sali Hassan, Chris Pal, Katharina-Sophia Bolinski<br/>
            </p>
            <br>

            <h3 class="ueberschriftenImpressum">Kontakt:</h3>
            <p>E-Mail: contact@handwars.de</p>
            <br>

            <h2 class="ueberschriftenImpressum">Haftungsausschluss (Disclaimer)</h2>
            <h3 class="ueberschriftenImpressum">Haftung für Inhalte</h3>
            ...
            <h3 class="ueberschriftenImpressum">Haftung für Links</h3>
            ...
            <h3 class="ueberschriftenImpressum">Urheberrecht</h3>
            <p>Die durch die
                Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht.
                Die
            ...
            <p>Soweit die Inhalte auf dieser Seite
            ...
            <h2 class="ueberschriftenImpressum">Datenschutzerklärung</h2>
            <h3 class="ueberschriftenImpressum">Datenschutz</h3>
            ...
            <h3 class="ueberschriftenImpressum">Datenschutzerklärung für die Nutzung von Facebook-Plugins (Like-Button)</h3>
            <p>Auf unseren Seiten sind Plugins
                des sozialen Netzwerks Facebook, Anbieter Facebook Inc., 1 Hacker Way, Menlo Park, California 94025,
                USA,
                integriert. Die Facebook-Plugins erkennen Sie an dem Facebook-Logo oder dem "Like-Button" ("Gefällt
                mir") auf
            ...
            <p>Wenn Sie unsere Seiten besuchen, wird über das Plugin eine direkte Verbindung zwischen Ihrem Browser und
                ...
                eingeloggt
                sind, können Sie die Inhalte unserer Seiten auf Ihrem Facebook-Profil verlinken. Dadurch kann Facebook
                den
            ...
            <p>Wenn Sie
                nicht wünschen, dass Facebook den Besuch unserer Seiten Ihrem Facebook-Nutzerkonto zuordnen kann, loggen
                Sie
                sich bitte aus Ihrem Facebook-Benutzerkonto aus.</p>
            <p></p>
            <br>

            <h3 class="ueberschriftenImpressum">Datenschutzerklärung für die Nutzung von Piwik</h3>
            <p>Diese Website benutzt den Open Source Webanalysedienst
                Piwik. Piwik verwendet sog. "Cookies". Das sind Textdateien, die auf Ihrem Computer gespeichert werden
                und die
                eine Analyse der Benutzung der Website durch Sie ermöglichen. Dazu werden die durch den Cookie erzeugten
                Informationen über die Benutzung dieser Website auf unserem Server gespeichert. Die IP-Adresse wird vor
                der
                Speicherung anonymisiert.</p>
            <p>Die durch den Cookie erzeugten Informationen über die Benutzung dieser Website
                werden nicht an Dritte weitergegeben. Sie können die Speicherung der Cookies durch eine entsprechende
            ...
            <p>Wenn Sie
                mit der Speicherung und Nutzung Ihrer Daten nicht einverstanden sind, können Sie die Speicherung und
                Nutzung
                hier deaktivieren. In diesem Fall wird in Ihrem Browser ein Opt-Out-Cookie hinterlegt der verhindert,
                dass Piwik
                Nutzungsdaten speichert. Wenn Sie Ihre Cookies löschen hat dies zur Folge, dass auch das Piwik
                Opt-Out-Cookie
                gelöscht wird. Das Opt-Out muss bei einem erneuten Besuch unserer Seite wieder aktiviert werden.</p>
            <p>
            <br>

            <iframe height="200px" scrolling="no"frameBorder="0"
                    src="https://handwars.de/piwik/index.php?module=CoreAdminHome&action=optOut&language=en"></iframe>

            <br>
            <h3 class="ueberschriftenImpressum">Cookies</h3>
